document.addEventListener('DOMContentLoaded', function () {
    ...
    section1.addEventListener('animationend', () => {
        setTimeout(() => {
            // show section 2 and start animation
            ...
            section2.addEventListener('animationend', () => {
                setTimeout(() => {
                    // show section 3, section 4 and footer
    ...
    // section 3 die on hover event handler
    $("#dice").hover(roll);

    // section 3 laptop on hover event handler
    $("#laptop").hover(function () {
        $("#laptop").toggleClass("laptop--closed");
    });

    // section 4 photo gallery on click event handler
    $(".option").click(function () {
        $(".option").removeClass("active");
        $(this).addClass("active");
    });

    // code for die rolling animation -- START
    const rots = [
        { ry: 0, rx: 0 }, // 1
        { ry: 90, rx: 0 }, // 2
        { ry: 180, rx: 0 }, // 3
    ...
    // code for die rolling animation -- END
});